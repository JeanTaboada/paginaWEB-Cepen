...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (alumnoData) {
        ...
        document.getElementById('profile-domicilio').textContent = alumnoData.Domicilio;
        document.getElementById('profile-email').textContent = alumnoData.Email;
        document.getElementById('profile-email2').textContent = alumnoData.Email2;
        ...
        document.getElementById('profile-turno').textContent = alumnoData.Turno;
