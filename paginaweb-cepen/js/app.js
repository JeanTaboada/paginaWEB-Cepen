            ...
            alumnosTable.innerHTML += `<tr>
                ...
                button.addEventListener('click', (e)=>{
                    ...
                    firebase
                        ...
                        .once('value')
                        .then((alumno)=>{
                        const data = alumno.val()
                        registerForm['nombre'].value = data.Nombre
                        registerForm['apePat'].value = data.Apellido_Paterno
                        registerForm['apeMat'].value = data.Apellido_Materno
                        registerForm['cel'].value = data.Telefono
                        registerForm['DNI'].value = data.DNI
                        registerForm['email'].value = data.Email
                        registerForm['carrera'].value = data.Carrera
                        registerForm['desc'].value = data.Descripcion
